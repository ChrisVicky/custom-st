 ...
 */
static char *font = "FiraCode Nerd Font Mono:style=Medium,Regular:size=13";
static char *font2[] = { 
    "Source Han Serif SC:size=14",
...
#define C_FRAPPE    2
#define C_LATTE     3
#define C_MACCHIATO 4
#define C_MOCHA     5
#define COLOR_SCHEMA C_MOCHA

#if COLOR_SCHEMA == C_DEFAULT
#include "default.h"
#elif COLOR_SCHEMA == C_FRAPPE
#include "frappe.h"
#elif COLOR_SCHEMA == C_LATTE
#include "latte.h"
#elif COLOR_SCHEMA == C_MACCHIATO
#include "macchiato.h"
#elif COLOR_SCHEMA == C_MOCHA
#include "mocha.h"
#endif 
